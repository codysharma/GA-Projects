...
- Putting everything you've learned so far together (arrays, loops, conditionals, objects, methods)
...
1. Fork this repository, `cd` into the directory created by the clone, and build a folder structure in that directory.
...
- Submit your homework via a PULL REQUEST and please don't forget to fill out the form!
